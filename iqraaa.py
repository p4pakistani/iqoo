...
def main_apv():
    ...
    print logo
    try:
        key1 = open('/sdcard/jimi.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        ...
        print '         YOUR KEY : ' + myid + jimi
        kok = open('/sdcard/jimi.txt', 'w')
        kok.write(myid + jimi)
        kok.close()
        print ''
    ...
    r1 = requests.get('https://pastebin.com/raw/mnqHg9G5').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print '             Agar Ap Na Subscription Kar Le Ha To'
        raw_input('  Termux Sa Exit Kar Ka Phir Sa Cammonds Lagio Thanks')
        os.system('xdg-open https://wa.me/ban ho gy dost')
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[*] Extracting From jimiIAZ : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('jok.txt', 'a')
    for i in z['data']:
